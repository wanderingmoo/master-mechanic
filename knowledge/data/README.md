...
- `tools/print-source-brief.rb` prints source-register entries by source ID, tier, status, or keyword, including local source notes, archived files, and extracted fact coverage.
