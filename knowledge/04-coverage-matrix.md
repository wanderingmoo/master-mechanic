...
2. Use an official race program, entry list, scrutineering record, Ford/JWA record, chassis record, or ACO-licensed Le Mans history volume to verify the 1968 entry's engine, lap count, full entrant name, chassis, and preparation details beyond the S025 official winner row.
