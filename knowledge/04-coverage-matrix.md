...
| Regulatory / homologation | baseline_captured | S009, S014, S015 | 1968 Appendix J context and Ford GT 40 No. 224 baseline are source-backed; S009 is now archived locally with checksum and usable text extraction. | ASN-certified homologation copy if event HTP use is required; any event-specific current rules. |
| Chassis and body | baseline_captured; settings_blocked | S009, S015, S026, S027 | Homologated wheelbase, track, weight context, material baseline, one official Ford Heritage Vault 1965 GT40 Mark I image/detail metadata anchor, and Ford press-release design-history context are captured. | Actual chassis identity, tub condition, repair history, material verification, body/clip configuration, original drawings or repair procedure. |
...
| Gurney-Weslake heads | baseline_captured; settings_blocked | S015, S024 | Weslake aluminium head variant, part number 3/3710, and Gurney-Weslake official Mark I-IV, William Mills GT40 race-head, LM8 Aeroplane and Motor road-head, later-conversion, and rocker-cover substitution boundaries are captured. | Installed head markings/foundry marks, valve sizes, chamber data, plug spec, repair limits, lash/cam compatibility. |
...
| Driveline / transaxle | component_support_captured; settings_blocked | S008, S009, S015, S016, S017 | Base ZF and 1968 Hewland LG600 evolution are captured; LG500/LG600 manual cautions, extraction provenance, inspection scope, lubrication cautions, selector-fork setup method, and final-drive setup boundaries are indexed; official ZF support/acquisition paths are captured for technical information, lubricants, catalog/partner lookup, and service. | Installed transaxle ID, serial, gearset, final drive, LSD type, oil/fill, preload/backlash, clutch release geometry; ZF 5DS-25 service data if installed unit is ZF. |
| Suspension and steering | baseline_captured; settings_blocked | S009, S015, S027 | Independent/coil-spring recognition context is captured; S015 item numbers 70-74, 78-82, and 60-63 are indexed as suspension/steering capture prompts and evidence boundaries; S027 adds early Ford GT double-wishbone design-history context; a suspension/steering capture template and blocked spring/damper/bar setting gate exist. | Actual pickup points, uprights, arms, spring/damper/bar data, shim packs, rack/column/steering-arm IDs, ride height, tires/use case, bump-steer data. |
| Brakes | baseline_captured; settings_blocked | S009, S015, S027 | Hydraulic brake and fail-safe period context is captured; S015 brake item numbers 91-105 and brake/hub photo anchors are indexed as inspection prompts and evidence boundaries; S027 adds early Ford GT 11.5-inch disc-brake design-history context. | Calipers, discs, masters, balance bar/proportioning, pads, fluid, bedding, torque values, pressure/bias data. |
...
| General workshop / fasteners | mechanic_ready_partial; settings_blocked | S015, S016, S018, S019, settings register | Fastener torque governance, blocked car-wide torque rule, and a fastener torque capture template are indexed. | Exact fastened joint, fastener specification, component source, thread/lubrication/locking condition, reuse rule, inspection condition, and applicable service data. |
| Settings coverage | mechanic_ready_partial; settings_blocked | Settings register, evidence-gap register, settings governance, settings compendium | All 33 tracked setup/settings topics are indexed in CSV and summarized by system in `knowledge/07-settings-compendium.md`; every setting has an evidence-gap linkage and safe next action. | Installed-component evidence and applicable primary/component sources are still required before numeric values become actionable. |
| Race history context | baseline_captured | S013, S023, S025, S027, S028 | The official 24H Le Mans palmarès API verifies the 1968 winning row core fields: #9, JWA, Ford GT 40, Pedro Rodriguez, and Lucien Bianchi, and the S025 JSON payload is archived locally with checksum; S027 adds `pdftotext`/visual extraction of Ford press-release context for Ford Total Performance, Ford Advanced Vehicles, GT40 development, Mark II/Mark IV history, and Gulf-sponsored Mark I Le Mans wins in 1968 and 1969; S028 identifies exact Dave Friedman Collection targets for Ford Motor Company Racing Endurance 1968, GT Program, and Shelby Racing research files. | Engine displacement, lap count, full entrant name, chassis identity, Gulf/JWA preparation detail, and installed-engine claims still require official entry/program/scrutineering/Ford/JWA/ACO-licensed evidence or acquired archive scans. |
| Assistant agent and reusable skills | mechanic_ready_partial | Local agent and skill files; S003; S020-S028 | Agent, mechanic-question-routing, source-triage, configuration-control, component-identification, settings-governance, safety-event-readiness, and diagnostics skills are installed locally; official Ford Heritage Vault, The Henry Ford archive, Gurney-Weslake, and ACO/Le Mans source paths are indexed for deeper Ford/GT40 source requests, including S028 box/folder-level Dave Friedman targets. | Needs more system-specific source depth before it can answer broad service-setting questions. |
...
1. Use S020-S022 and S028 to request period JWA/Ford GT40 302 engine build, race-preparation, Ford press, performance-testing, production-record, or part-drawing material, prioritizing S028 Box 116 Endurance 1968, Box 117 GT Program, and Box 160 Shelby Racing correspondence/report targets.
2. Use an official race program, entry list, scrutineering record, Ford/JWA record, chassis record, or ACO-licensed Le Mans history volume to verify the 1968 entry's engine, lap count, full entrant name, chassis, and preparation details beyond the S025 official winner row and S027 Ford press-release context.
...
5. ZF 5DS-25 component documentation through S008 or another primary source if the installed unit is base ZF rather than Hewland.
