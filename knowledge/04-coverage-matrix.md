...
| Race history context | baseline_captured | S013, S023, S025, S027 | The official 24H Le Mans palmarès API verifies the 1968 winning row core fields: #9, JWA, Ford GT 40, Pedro Rodriguez, and Lucien Bianchi; S027 adds an official Ford Heritage Vault GT40/Le Mans press-release archive anchor with PDF archived but not text-extracted. | Engine displacement, lap count, full entrant name, chassis identity, Gulf/JWA preparation detail, and installed-engine claims still require official entry/program/scrutineering/Ford/JWA/ACO-licensed evidence; S027 PDF body needs OCR/manual extraction before it can support content claims. |
...
2. OCR or manually extract S027's archived Ford Heritage Vault PDF, then promote only directly supported claims into source notes and the fact register.
3. Use an official race program, entry list, scrutineering record, Ford/JWA record, chassis record, or ACO-licensed Le Mans history volume to verify the 1968 entry's engine, lap count, full entrant name, chassis, and preparation details beyond the S025 official winner row.
4. Gurney-Weslake cylinder-head service drawings, valve/plug/chamber data, or repair-limit source beyond S024 identification context.
5. Installed car evidence: chassis number, engine/block/head photos, carburetor IDs, transaxle ID, brake hardware, wheel/hub/tire data.
6. ZF 5DS-25 component documentation through S008 or another primary source if the installed unit is base ZF rather than Hewland.
7. Brake/wheel/center-lock component manuals or period GT40 service references.
