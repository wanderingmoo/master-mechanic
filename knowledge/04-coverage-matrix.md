...
| Race history context | baseline_captured | S013, S023, S025, S027 | The official 24H Le Mans palmarès API verifies the 1968 winning row core fields: #9, JWA, Ford GT 40, Pedro Rodriguez, and Lucien Bianchi; S027 adds `pdftotext`/visual extraction of Ford press-release context for Ford Total Performance, Ford Advanced Vehicles, GT40 development, Mark II/Mark IV history, and Gulf-sponsored Mark I Le Mans wins in 1968 and 1969. | Engine displacement, lap count, full entrant name, chassis identity, Gulf/JWA preparation detail, and installed-engine claims still require official entry/program/scrutineering/Ford/JWA/ACO-licensed evidence. |
| Assistant agent and reusable skills | mechanic_ready_partial | Local agent and skill files; S003; S020-S027 | Agent, mechanic-question-routing, source-triage, configuration-control, component-identification, settings-governance, safety-event-readiness, and diagnostics skills are installed locally; official Ford Heritage Vault, The Henry Ford archive, Gurney-Weslake, and ACO/Le Mans source paths are indexed for deeper Ford/GT40 source requests. | Needs more system-specific source depth before it can answer broad service-setting questions. |
