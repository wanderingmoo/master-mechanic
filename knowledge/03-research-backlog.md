...
| P2 | Period Ford/FAV/JWA GT40 service and race-preparation documents | Needed to move from lead-only historical context to period mechanic guidance | Ford Heritage Vault is captured as S003 and its GT40 search returned 84 records; S026 now indexes one official Ford Heritage Vault 1965 GT40 Mark I image/detail record as a body-context/source-acquisition anchor; The Henry Ford Ford Motorsports Records, Dave Friedman Collection, and remote research services are captured as S020-S022 acquisition paths; specific service/prep documents still not obtained |
